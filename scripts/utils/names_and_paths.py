...
AUTOGENERATED_CONFIG = 'autogenerated.config'
...
CERT_ATTR_TO_PATH_MAPPING = {
    'web_key_file': 'certs/web_key.pem',
    'web_cert_file': 'certs/web_cert.pem',
    'web_cert_chain_file': 'certs/web_chain.pem',
    'cacerts_dir': 'cacerts'
}
